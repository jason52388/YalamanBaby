// Week-by-week pregnancy plan (weeks 1–40).
//
// Each week has:
//   focus    – a short headline for what this week is about
//   summary  – a sentence or two on what's happening / what to keep in mind
//   todos    – actionable checklist items ({ text } or { text, note })
//   appts    – appointments, tests, or vaccines relevant around this week
//   tips      – gentle advice for the week
//
// `todos` and `appts` render as checkboxes that you can tick off — your
// progress is saved on this device.
//
// This is general guidance compiled from common pregnancy resources and is
// NOT medical advice. Your provider's schedule and recommendations always
// come first — timing of tests, classes, and visits varies by person,
// pregnancy, and country.
...
export const plan = {
  ...
  11: {
    ...
    todos: [
      t('Begin thinking about when and how you’d like to share the news'),
    ],
